...
/**
 * @author easoll on 2018-04-18
 *
 * 参考链接 http://open-wiki.flyme.cn/index.php?title=%E7%8A%B6%E6%80%81%E6%A0%8F%E5%8F%98%E8%89%B2
 */
public class FlymeStatusbarColorUtils {
     ...
     * @param color    颜色
     */
    public static void setStatusBarDarkIcon(Activity activity, int color) throws Throwable {
     ...
     * @param color  颜色
     */
    public static void setStatusBarDarkIcon(Window window, int color) throws Throwable {
        try {
     ...
     */
    public static void setStatusBarDarkIcon(Activity activity, boolean dark) throws Throwable {
        setStatusBarDarkIcon(activity, dark, true);
    }

    private static boolean changeMeizuFlag(WindowManager.LayoutParams winParams, String flagName, boolean on) throws Throwable {
        try {
     ...
     * @param color
     */
    private static void setStatusBarColor(Window window, int color) throws Throwable {
     ...
     * @param dark   是否深色 true为深色 false 为白色
     */
    public static void setStatusBarDarkIcon(Window window, boolean dark) throws Throwable {
    ...
    private static void setStatusBarDarkIcon(Activity activity, boolean dark, boolean flag) throws Throwable {
